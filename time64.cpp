...
cTime64::cTime64(time_t timer) {from_time_t(timer);}
...
void cTime64::from_time_t(time_t timer) {
...
cDate64::cDate64(time_t timer) {from_time_t(timer);}
...
void cDate64::from_time_t(time_t timer) {
